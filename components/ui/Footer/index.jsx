    ...
    <footer className="pt-32 sm:pt-44">
        <div className="custom-screen text-gray-600">
            ...
            <div className="mt-10 py-10 border-t flex-row-reverse items-center justify-between sm:flex">
                <ul className="flex flex-wrap items-center gap-4 sm:text-sm">
                    {
                        navigation.map((item, idx) => (
                            <li key={idx} className="font-medium text-gray-700 dark:text-gray-200 hover:text-gray-900 dark:hover:text-white duration-150">
                                <Link href={item.href}>
                                    {item.name}
                                </Link>
                            </li>
                ...
                <p className="mt-6 sm:mt-0 text-gray-700 dark:text-gray-200">© 2023 Split Inc. All rights reserved.</p>
            </div>
        </div>
    </footer>
)

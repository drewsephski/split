...
const FAQs = () => (
    <SectionWrapper id="faqs">
        <div className="custom-screen text-gray-600 dark:text-gray-200">
            <div className="max-w-xl xl:mx-auto xl:text-center">
                <h2 className="text-gray-800 dark:text-white text-3xl font-extrabold sm:text-4xl">
                ...
                <p className="mt-3 text-gray-600 dark:text-gray-200">
                    ...
                    <a
                        className='text-blue-600 hover:text-blue-400 dark:text-blue-400 dark:hover:text-blue-300 duration-150 font-semibold whitespace-nowrap'
            ...
            <div className='mt-12'>
                <ul className='space-y-8 gap-12 grid-cols-2 sm:grid sm:space-y-0 lg:grid-cols-3'>
                    {faqsList.map((item, idx) => (
                        ...
                        >
                            <summary
                                className="flex items-center justify-between font-semibold text-gray-800 dark:text-white">
                                {item.q}
                            </summary>
                            <p
                                dangerouslySetInnerHTML={{ __html: item.a }}
                                className='leading-relaxed text-gray-600 dark:text-gray-200'>
                            </p>
                        </li>
                    ))}
                </ul>
